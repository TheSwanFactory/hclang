...
var Frame = (function () {
    ...
    Frame.prototype.toMetaKeys = function () {
        return Object.keys(this.meta);
    };
    Frame.prototype.toMetaKeyValuePairs = function () {
        var _this = this;
        var keys = this.toMetaKeys();
        return keys.map(function (key) {
            var pair = [key, _this.meta[key]];
            return pair;
        });
    };
    Frame.prototype.toFunctionalMetaString = function () {
        var pairs = this.toMetaKeyValuePairs();
