...
decimal or inexact number. `%%` accepts integers only. Sequences and typed
numbers reject arithmetic, ordering, signs, and repetition; a typed number
refuses even a same-unit operand.
