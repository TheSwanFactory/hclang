...
export { FrameList, IArrayConstructor } from './frames/frame-list.ts'
...
export { FrameString, IStringConstructor } from './frames/frame-string.ts'
export { FrameOperator, FrameSymbol } from './frames/frame-symbol.ts'
export { Frame } from './frames/frame.ts'
export { Context, IKeyValuePair, ISourced, MetaFrame, NilContext } from './frames/meta-frame.ts'
Frame.globals = Ops
